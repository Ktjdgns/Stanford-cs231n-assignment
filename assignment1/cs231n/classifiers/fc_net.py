...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # loss, dx = softmax_loss(scores, y)  # dx is the gradient of Loss with respect to x(scores)
        # loss += 0.5 * self.reg * (np.sum(self.params['W1'] ** 2) + np.sum(self.params['W2'] **2))

        # layer2_dx, layer2_dw, layer2_db = affine_backward(dx, affine2_cache)  # dx = dL/d(score)
        ...
        # _, layer1_dw, layer1_db = affine_backward(relu_dx, affine1_cache)
